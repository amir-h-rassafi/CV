...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	{\href{https://aut.ac.ir/EN}{Amirkabir University of Technology}} % Institution
	...
	\qualificationentry
		...
		{GPA Major:3.81/4 Minor:3.82/4} % Honors, achievements or distinctions (e.g. first class honors)
		{Electrical(Major) Computer(Minor)} % Department
		{\href{https://aut.ac.ir/EN}{Amirkabir University of Technology}} % Institution
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{2013}{\textbf{\textbf{Ranked 700} over 250,000 participants}}{}
